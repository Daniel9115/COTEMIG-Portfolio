...
begin
    ...
    -- calcular preço (exemplo: preço fixo de 10.00)
    set v_preco = 10.00;
...
insert into carrinho (carrinho_json) values ('{"codigoproduto": 1, "codigocliente": 1, "codigovendedor": 1, "qtde": 2}');
call sp_extrair_carrinho('{"codigoproduto": 2, "codigocliente": 1, "codigovendedor": 1, "qtde": 2}');
